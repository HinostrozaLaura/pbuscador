...
const arregloPeliculas=[
    ...
    {id:4, nombre:"Amante Doble",Genero:"Drama",precio:750},
    ...
    render(){
        ...
        return(
            ...
            <div style={{display:"flex",backgroundColor:"red"}}>
              ...
              <ListadoElemento AgregarAlCarrito={this.AgregarAlCarrito} Peliculas={ListaPeliculas} />
                </div>

                    <div style={{flex:1,backgroundColor:"red"}}>
                     Carrito de Compras
                     <div>total :{total}</div>
                     <ListadoElemento Peliculas={Listacarrito}/>
